export const translations = {
  en: {
    ...
    skillsSummary: 'From concept to deployment, I transform ideas into robust digital products. I enjoy solving complex problems and optimizing performance at every layer of the stack.',
    frontend: 'Frontend',
    backend: 'Backend',
    ...
    contactDescription: 'Open to new challenges and exciting opportunities. Let\'s talk about how I can contribute to your team\'s success.',
    email: 'Email',
    phone: 'Phone',
    location: 'Location',
    findMeOn: 'Find me on:',
    sendMessage: 'Send me a Direct Message',
    sendMessageDescription: 'Interested in my profile for your team? Send me a message and I\'ll get back to you as soon as possible.',
    yourName: 'Your Name',
  ...
  es: {
    ...
    skillsSummary: 'Del concepto al despliegue, transformo ideas en productos digitales robustos. Disfruto resolver problemas complejos y optimizar el rendimiento en cada capa del stack.',
    frontend: 'Frontend',
    backend: 'Backend',
    ...
    contactDescription: 'Abierto a nuevos desafíos y oportunidades emocionantes. Hablemos sobre cómo puedo contribuir al éxito de tu equipo.',
    email: 'Email',
    phone: 'Teléfono',
    location: 'Ubicación',
    findMeOn: 'Encuéntrame en:',
    sendMessage: 'Envíame un Mensaje Directo',
    sendMessageDescription: '¿Interesado en mi perfil para tu equipo? Envíame un mensaje y te responderé lo antes posible.',
    yourName: 'Tu Nombre',
    yourEmail: 'Tu Correo',
    subject: 'Asunto',
